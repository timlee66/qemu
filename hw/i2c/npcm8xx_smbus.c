...
#include "hw/i2c/npcm8xx_smbus.h"
...
#define NPCM7XX_SMBTXF_CTL_TX_THR(rv)       extract8((rv), 0, 6)
/* T_OUT fields */
...
#define NPCM7XX_SMBTXF_STS_TX_BYTES(rv)     extract8((rv), 0, 6)
/* RXF_STS fields */
#define NPCM7XX_SMBRXF_STS_RX_THST          BIT(6)
#define NPCM7XX_SMBRXF_STS_RX_BYTES(rv)     extract8((rv), 0, 6)
/* RXF_CTL fields */
#define NPCM7XX_SMBRXF_CTL_THR_RXIE         BIT(6)
#define NPCM7XX_SMBRXF_CTL_LAST             BIT(7)
#define NPCM7XX_SMBRXF_CTL_RX_THR(rv)       extract8((rv), 0, 6)
...
static void npcm7xx_smbus_update_irq(NPCM8xxSMBusState *s)
{
    int level;
...
static void npcm7xx_smbus_nack(NPCM8xxSMBusState *s)
{
    s->st &= ~NPCM7XX_SMBST_SDAST;
    s->st |= NPCM7XX_SMBST_NEGACK;
...
static void npcm7xx_smbus_clear_buffer(NPCM8xxSMBusState *s)
{
    s->fif_cts &= ~NPCM7XX_SMBFIF_CTS_RXF_TXE;
    s->txf_sts = 0;
    s->rxf_sts = 0;
...
static void npcm7xx_smbus_send_byte(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_recv_byte(NPCM8xxSMBusState *s)
{
...
static void npcm7xx_smbus_recv_fifo(NPCM8xxSMBusState *s)
{
    ...
    while (received_bytes < expected_bytes &&
           received_bytes < NPCM8XX_SMBUS_FIFO_SIZE) {
        pos = (s->rx_cur + received_bytes) % NPCM8XX_SMBUS_FIFO_SIZE;
    ...
    if (received_bytes == NPCM8XX_SMBUS_FIFO_SIZE) {
        s->st |= NPCM7XX_SMBST_SDAST;
        s->fif_cts |= NPCM7XX_SMBFIF_CTS_RXF_TXE;
...
static void npcm7xx_smbus_read_byte_fifo(NPCM8xxSMBusState *s)
{
    uint8_t received_bytes = NPCM7XX_SMBRXF_STS_RX_BYTES(s->rxf_sts);
    ...
    s->rx_cur = (s->rx_cur + 1u) % NPCM8XX_SMBUS_FIFO_SIZE;
    --s->rxf_sts;
    npcm7xx_smbus_update_irq(s);
}

static void npcm7xx_smbus_start(NPCM8xxSMBusState *s)
{
    /*
...
static void npcm7xx_smbus_send_address(NPCM8xxSMBusState *s, uint8_t value)
{
    int recv;
    int rv;
...
static void npcm7xx_smbus_execute_stop(NPCM8xxSMBusState *s)
{
...
static void npcm7xx_smbus_stop(NPCM8xxSMBusState *s)
{
...
static uint8_t npcm7xx_smbus_read_sda(NPCM8xxSMBusState *s)
{
    uint8_t value = s->sda;
...
static void npcm7xx_smbus_write_sda(NPCM8xxSMBusState *s, uint8_t value)
{
    s->sda = value;
    if (s->st & NPCM7XX_SMBST_MODE) {
        switch (s->status) {
...
static void npcm7xx_smbus_write_st(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_cst(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_cst3(NPCM8xxSMBusState *s, uint8_t value)
{
    s->cst3 = WRITE_ONE_CLEAR(s->cst3, value, NPCM7XX_SMBCST3_EO_BUSY);
    npcm7xx_smbus_update_irq(s);
}

static void npcm7xx_smbus_write_ctl1(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_ctl2(NPCM8xxSMBusState *s, uint8_t value)
{
    s->ctl2 = value;
...
static void npcm7xx_smbus_write_ctl3(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_fif_ctl(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_fif_cts(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_txf_ctl(NPCM8xxSMBusState *s, uint8_t value)
{
    s->txf_ctl = value;
}

static void npcm7xx_smbus_write_t_out(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_txf_sts(NPCM8xxSMBusState *s, uint8_t value)
{
    s->txf_sts = WRITE_ONE_CLEAR(s->txf_sts, value, NPCM7XX_SMBTXF_STS_TX_THST);
}

static void npcm7xx_smbus_write_rxf_sts(NPCM8xxSMBusState *s, uint8_t value)
{
...
static void npcm7xx_smbus_write_rxf_ctl(NPCM8xxSMBusState *s, uint8_t value)
{
    uint8_t new_ctl = value;
...
{
    NPCM8xxSMBusState *s = NPCM8XX_SMBUS(obj);
...
static const VMStateDescription vmstate_npcm7xx_smbus = {
    ...
    .fields = (const VMStateField[]) {
        VMSTATE_UINT8(sda, NPCM8xxSMBusState),
        VMSTATE_UINT8(st, NPCM8xxSMBusState),
        VMSTATE_UINT8(cst, NPCM8xxSMBusState),
        VMSTATE_UINT8(cst2, NPCM8xxSMBusState),
        VMSTATE_UINT8(cst3, NPCM8xxSMBusState),
        VMSTATE_UINT8(ctl1, NPCM8xxSMBusState),
        VMSTATE_UINT8(ctl2, NPCM8xxSMBusState),
        VMSTATE_UINT8(ctl3, NPCM8xxSMBusState),
        VMSTATE_UINT8(ctl4, NPCM8xxSMBusState),
        VMSTATE_UINT8(ctl5, NPCM8xxSMBusState),
        VMSTATE_UINT8_ARRAY(addr, NPCM8xxSMBusState, NPCM7XX_SMBUS_NR_ADDRS),
        VMSTATE_UINT8(scllt, NPCM8xxSMBusState),
        VMSTATE_UINT8(sclht, NPCM8xxSMBusState),
        VMSTATE_UINT8(fif_ctl, NPCM8xxSMBusState),
        VMSTATE_UINT8(fif_cts, NPCM8xxSMBusState),
        VMSTATE_UINT8(fair_per, NPCM8xxSMBusState),
        VMSTATE_UINT8(txf_ctl, NPCM8xxSMBusState),
        VMSTATE_UINT8(t_out, NPCM8xxSMBusState),
        VMSTATE_UINT8(txf_sts, NPCM8xxSMBusState),
        VMSTATE_UINT8(rxf_sts, NPCM8xxSMBusState),
        VMSTATE_UINT8(rxf_ctl, NPCM8xxSMBusState),
        VMSTATE_UINT8_ARRAY(rx_fifo, NPCM8xxSMBusState,
                            NPCM8XX_SMBUS_FIFO_SIZE),
        VMSTATE_UINT8(rx_cur, NPCM8xxSMBusState),
        VMSTATE_END_OF_LIST(),
    },
};
...
static const TypeInfo npcm7xx_smbus_types[] = {
    {
        ...
        .instance_size = sizeof(NPCM8xxSMBusState),
